...
<reference>
@C:/Users/xhiep/Downloads/dubbing-extractor/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/Users/xhiep/Downloads/dubbing-extractor/.claude/get-shit-done/references/user-profiling.md` to load:
