...
```
Task(
  prompt="Read C:/Users/xhiep/Downloads/dubbing-extractor/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/xhiep/Downloads/dubbing-extractor/.claude/get-shit-done/templates/SECURITY.md`
