...
```markdown
Read C:/Users/xhiep/Downloads/dubbing-extractor/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/Users/xhiep/Downloads/dubbing-extractor/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/Users/xhiep/Downloads/dubbing-extractor/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/Users/xhiep/Downloads/dubbing-extractor/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/Users/xhiep/Downloads/dubbing-extractor/.claude/agents/gsd-eval-planner.md for instructions.
