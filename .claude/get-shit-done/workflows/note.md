...
- **Global scope**: `C:/Users/xhiep/Downloads/dubbing-extractor/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/xhiep/Downloads/dubbing-extractor/.claude/notes/`)
...
2. Glob `C:/Users/xhiep/Downloads/dubbing-extractor/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/xhiep/Downloads/dubbing-extractor/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/xhiep/Downloads/dubbing-extractor/.claude/notes/` — works in any directory
