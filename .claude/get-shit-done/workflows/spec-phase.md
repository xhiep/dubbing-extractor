...
```bash
INIT=$(node "C:/Users/xhiep/Downloads/dubbing-extractor/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/xhiep/Downloads/dubbing-extractor/.claude/get-shit-done/templates/spec.md.
